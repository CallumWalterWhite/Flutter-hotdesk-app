...
class HomePage extends StatelessWidget {
  ...
  static String datetimeStr = DateTime.now().toString();

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Hotdesk booker'),
      ),
      body: ListView(
        children: <Widget>[
          Image.asset('assets/codelab.png'),
          const SizedBox(height: 8),
          IconAndDetail(Icons.calendar_today, datetimeStr),
          const IconAndDetail(Icons.location_city, 'MHR'),
